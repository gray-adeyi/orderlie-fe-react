...
const UploadBioData = () => {
	return (
		<div className=' mx-2 my-10 font-serrat'>
			...
			<div className='mt-10 flex justify-center'>
				<div className='border border-bgColor w-full  mx-14 rounded-3xl md:px-5 px-4 py-4 mb-6 '>
					...
					<div className='grid grid-cols-1 gap-4 px-32'>
						<div className='flex flex-col'>
							...
							<input
								type='text'
								className='mt-1 p-4 w-full border rounded-2xl focus:outline-none border-bgColor focus:border-green-500 shadow-lg shadow-gray-400'
						...
						<div className='flex flex-col'>
							<label className=' text-2xl font-semibold'>Middle Name</label>
							<input
								type='text'
								className='mt-1 p-4 w-full border rounded-2xl focus:outline-none border-bgColor focus:border-green-500 shadow-lg shadow-gray-400'
								placeholder=''
						...
						<div className='flex flex-col'>
							<label className=' text-2xl font-semibold'>Matric No</label>
							<input
								type='text'
								className='mt-1 p-4 w-full border rounded-2xl focus:outline-none border-bgColor focus:border-green-500 shadow-lg shadow-gray-400'
								placeholder=''
						...
						<div className=' btn mt-6 w-full rounded-xl py-2 px-4 text-white bg-bgColor flex items-center justify-center font-bold text-xl'>
